...
class Generator(nn.Module):
    def __init__(self, eta):
        ...
        self.paragraph_cnet11 = nn.Sequential(nn.ReflectionPad2d((1, 1, 1, 1)),
        ...
        self.paragraph_cnet12 = nn.Sequential(nn.ReflectionPad2d((1, 1, 1, 1)),
        ...
        init_weight_(self.paragraph_cnet11)
        init_weight_(self.paragraph_cnet12)

        self.paragraph_cnet21 = nn.Sequential(nn.Conv2d(in_channels=64,
                                                       out_channels=128,
                                                       kernel_size=3,
                                                       stride=2,
                                                       padding=1,
        ...
        self.paragraph_cnet22 = nn.Sequential(nn.Conv2d(in_channels=128,
                                                       out_channels=256,
                                                       kernel_size=3,
                                                       stride=2,
                                                       padding=1,
        ...
        self.paragraph_cnet23 = nn.Sequential(nn.Conv2d(in_channels=256,
                                                       out_channels=512,
                                                       kernel_size=3,
                                                       stride=(4, 3),
                                                       padding=1,
        ...
        init_weight_(self.paragraph_cnet21)
        init_weight_(self.paragraph_cnet22)
        init_weight_(self.paragraph_cnet23)
        ...
        self.paragraph_ctnet12 = nn.Sequential(nn.ConvTranspose2d(in_channels=256,
                                                                 out_channels=128,
                                                                 kernel_size=3,
                                                                 stride=2,
                                                                 padding=1,
        ...
        self.paragraph_ctnet13 = nn.Sequential(nn.ConvTranspose2d(in_channels=128,
                                                                 out_channels=64,
                                                                 kernel_size=3,
                                                                 stride=2,
                                                                 padding=1,
        ...
        init_weight_(self.paragraph_ctnet12)
        init_weight_(self.paragraph_ctnet13)
