import numpy as np
from dataset.grunge_library.grunge_db import *
from music.db_fragments.riff import UnitBassRiff, UnitGuitarRiff


def generate_unit_riff_nonzeros():
    unit_guitar_riff_dir = 'E:/grunge_library/unit_riffs/transposed/guitar/'
    unit_bass_riff_dir = 'E:/grunge_library/unit_riffs/transposed/bass/'
