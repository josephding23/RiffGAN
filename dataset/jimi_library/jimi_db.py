...
def get_performers_table():
    client = MongoClient()
    return client.jimi_db.performers


def get_albums_table():
    client = MongoClient()
    return client.jimi_db.albums


def get_songs_table():
    client = MongoClient()
    return client.jimi_db.songs


def get_guitar_riff_table():
    client = MongoClient()
    return client.jimi_db.guitar_riff


def get_bass_riff_table():
    client = MongoClient()
    return client.jimi_db.bass_riff


def get_unit_guitar_riff_table():
    client = MongoClient()
    return client.jimi_db.unit_guitar_riff


def get_unit_bass_riff_table():
    client = MongoClient()
    return client.jimi_db.unit_bass_riff


def get_guitar_solo_table():
    client = MongoClient()
    return client.jimi_db.guitar_solo


def get_bass_solo_table():
    client = MongoClient()
    return client.jimi_db.bass_solo
