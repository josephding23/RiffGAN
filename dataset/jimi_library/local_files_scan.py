...
def scan_local_files():
    ...
    album_num = len(os.listdir(root_dir))
    ...
    for album in os.listdir(root_dir):
        ...
        for song in os.listdir(album_dir):
            ...
            guitar_riff_dir = song_dir + '/' + 'GRIFF'
            bass_riff_dir = song_dir + '/' + 'BRIFF'
            guitar_solo_dir = song_dir + '/' + 'GSOLO'
        ...
        performers_table.insert_one({
            'Name': performer,
            'Albums': len(os.listdir(root_dir)),
            'AlbumNum': album_num,
